...
UNION ALL
SELECT 224, 'mod_photostation', 'module', 'mod_photostation', '', 0, 1, 1, 0, '', '', '', '', 0, '1900-01-01 00:00:00', 0, 0
UNION ALL
...
CREATE TABLE [#__photostation] (
	[usr] [nvarchar](255),
	[id] [nvarchar](255),
	[share] [nvarchar](255),
	CONSTRAINT [PK_#__photostation] PRIMARY KEY CLUSTERED
	(
		[usr] ASC
	)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY];
